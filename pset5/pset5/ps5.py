...
class AndTrigger(Trigger):
    def __init__(self, trigOne, trigTwo): 
        self.trigOne = trigOne
        self.trigTwo = trigTwo
        
    def evaluate(self, story): 
        return self.trigOne.evaluate(story) and self.trigTwo.evaluate(story)  
...
class OrTrigger(Trigger):
    ...
    def evaluate(self, story): 
        return self.trigOne.evaluate(story) or self.trigTwo.evaluate(story)
